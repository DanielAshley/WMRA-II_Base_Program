...
long DMC4143::getPosition(int motor)
{
	long encoderVal;
...
long DMC4143::getVelocity(int motor)
{
	long encoderVal;
	string command, result;
	if(motor == 1)
...
long DMC4143::getTorque(int motor)
{
	long encoderVal;
	string command, result;
	if(motor == 1)
...
double DMC4143::encToAng(int motor, long encCount)
{
